...
tutorial.steps = [
   ...
   "Click <b>Add a note</b> and write a more detailed description: \"for the cake\"",
   ...
   "Double-click on this to-do, and change its due date to next Saturday.",
   "Click on the bell-shaped icon at the top left of the screen. This is were notifications (or \"Activities\") will be shown.",
   "Click on the magnifier icon above it, and search for \"movie\". Your to-do \"watch a good movie\" should appear.",
...
tutorial.start = function() {
   ...
   if (experiment.conditions[experiment.pid][0] > 0)
